  ...
  return (
    <section className='confirm'>
        ...
        <div className='confirm-container'>
            ...
            <p className='confirm-subtitle'>Todo listo, {user.nombre}. Te esperamos en Carwash El Flaco para dejar tu auto como nuevo.</p>
            <div className='confirm-button-container'>
                <button className='confirm-button' onClick={() => navigate("/perfil")}> 
            ...
            <div className='confirm-content'>
                ...
                <div className='confirm-resume-content'>
                    ...
                    <div className='confirm-resume-item'>
                        <h4 className='confirm-resume-title'>Vehiculo</h4>
                        <p className='confirm-resume-text'>{storage.data.car}, Placas: {storage.data.plate ? storage.data.plate : 'Sin Placas'}</p>
                    </div>
                    <div className='confirm-resume-item'>
                ...
                <div className='confirm-map-container'>
                    ...
                    <div className='confirm-map-content'>
                        <div className='confirm-map-text-container'>
                            <p className='confirm-map-text'>CarWash El Flaco</p>
