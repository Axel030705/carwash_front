  ...
  return (
    <section className='m1banner'>
        ...
        <div className='m1banner-content'>
            <h1 className='m1banner-title'>TU ESTILO MERECE LO MEJOR</h1>
            <p className='m1banner-text'>
                El servicio de barbería más preciso y profesional de la ciudad. Déjanos <br />
                cuidar de tu imagen mientras te relajas.
            </p>
